...
public final class captainsAdd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        \n");
      out.write("        \n");
      out.write("        <form id=\"captain\"  class=\"form-horizontal\" style=\"width: 750px;border: solid;padding: 20px;border-color: lightskyblue;margin-bottom: 50px;margin-left: 300px;border-radius: 25px;border-width: 10px;position: absolute;visibility: hidden\" name=\"myForm\" action=\"addCaptains\" method=\"post\" >\n");
      ...
      out.write("\n");
      out.write("\n");
      out.write("        <form  id=\"ships\"  class=\"form-horizontal\" style=\"width: 750px;border: solid;padding: 20px;border-color: lightskyblue;margin-bottom: 50px;margin-left: 300px;border-radius: 25px;border-width: 10px;position: absolute;visibility: hidden\" name=\"myForm\" action=\"addShip\" method=\"post\" >\n");
      out.write("            <div class=\"form-group\">\n");

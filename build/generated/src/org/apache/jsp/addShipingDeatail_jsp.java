...
public final class addShipingDeatail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    <body>\n");
      out.write("        \n");
      out.write("        <h1>Shipping detail</h1>\n");
      ...
      out.write("            <button id=\"shipin1\" type=\"button\" class=\"btn btn-default btn-lg\" onclick=\"myFunction1()\">Add shipping in</button>\n");
      out.write("            <button id=\"shipout2\" type=\"button\" class=\"btn btn-default btn-lg\" onclick=\"myFunction2()\">Add shipping out</button>\n");
      out.write("</p>\n");
      out.write("        <form action=\"shippingInServlet\" onSubmit=\"return check()\" id=\"shipin\"  class=\"form-horizontal\" style=\"width: 750px;border: solid;padding: 20px;border-color: lightskyblue;margin-bottom: 50px;margin-left: 300px;border-radius: 25px;border-width: 10px;position: absolute;visibility: visible\" name=\"myForm\"  method=\"post\" >\n");
      out.write("         <h3>Shipping in</h3>  \n");
      ...
      out.write("                    \n");
      out.write("                    \n");
      out.write("     <form action=\"shippingOutServlet\" onSubmit=\"return check()\" id=\"shipout\"  class=\"form-horizontal\" style=\"width: 750px;border: solid;padding: 20px;border-color: lightskyblue;margin-bottom: 50px;margin-left: 300px;border-radius: 25px;border-width: 10px;position: absolute;visibility: hidden\" name=\"myForm\"  method=\"post\" >\n");
      out.write("         <h3>Shipping out</h3>\n");
      out.write("            <div class=\"form-group\">\n");
      out.write("                <label class=\"col-sm-2 control-label\" >Travel no</label>\n");
      out.write("                <div class=\"col-sm-10\">\n");
      out.write("                    <select class=\"form-control\" name=\"in\" id=\"param2\">\n");

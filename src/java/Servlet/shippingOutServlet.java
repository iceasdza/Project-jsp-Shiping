 ...
 * @author patiz
 */
public class shippingOutServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
     ...
     response.setContentType("text/html;charset=UTF-8");
        String travelno = request.getParameter("in");
        String pro = request.getParameter("out");
        
        int no = Integer.parseInt(travelno);
        product p = product.findByName(pro);
        ...
        if(travelno != null && pro != null){
            ...
            request.setAttribute("msg", "information fail to added !");
        }
